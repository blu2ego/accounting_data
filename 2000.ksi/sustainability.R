  ...
  if(length(flag_next) == 1){  # there exist next burton
    ...
    for(j in 1:length(li)) {
      ...
      for(i in 1:length(download_links)){
        ...
        download.file(download_url, destfile = 
                        paste0("C:/Users/nabataea/Google ????????????(muoe78@kNou.ac.kr)/문서/projects/sustainability/ksr_kor/", dest_file_name))
      }
    ...
    for(j in 1:length(li)) {
      ...
      for(i in 1:length(download_links)){
        ...
        download.file(download_url, destfile = 
                        paste0("C:/Users/nabataea//projects/sustainability/ksr_kor/", dest_file_name))
      }
