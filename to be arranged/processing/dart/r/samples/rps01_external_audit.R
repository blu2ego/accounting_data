...
external_audit <- jsonlite::toJSON(external_audit_contents, pretty = TRUE, auto_unbox = TRUE)

# json 파일로 writing 하려면,
write(external_audit, "~/projects/ward/results/dart/for_accounting/samples/external_audit.json") 
