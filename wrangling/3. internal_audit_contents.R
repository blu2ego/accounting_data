...
# 보고서 메타 데이터(감사보고서)
meta_report_audit <- list("fiscal_year" = "2019", "year_end" = "12", "corp_code" = "00126380", "stock_code" = "005930", "corp_name" = "삼성전자", 
...
internal_accounting_audit <- list("내부회계관리제도에 대한 감사의견" = '우리는 2019년 12월 31일 현재 내부회계관리제도 설계 및 운영 개념체계에 근거한 삼성전자주식회사(이하 "회사")의 내부회계관리제도를 감사하였습니다. 우리의 의견으로는 회사의 내부회계관리제도는 2019년 12월 31일 현재「내부회계관리제도 설계 및 운영 개념체계」에 따라 중요성의 관점에서 효과적으로 설계 및 운영되고 있습니다. 우리는 또한 회계감사기준에 따라, 회사의 2019년 12월 31일 현재의 재무상태표, 동일로 종료되는 보고기간의 손익계산서, 포괄손익계산서, 자본변동표, 현금흐름표 그리고 유의적인 회계정책의 요약을 포함한 재무제표의 주석을 감사하였으며, 2020년 2월 21일자 감사보고서에서 적정의견을 표명하였습니다.',
                                  "내부회계관리제도 감사의견 근거" = '우리는 회계감사기준에 따라 감사를 수행하였습니다. 이 기준에 따른 우리의 책임은 이 감사보고서의 내부회계관리제도에 대한 감사인의 책임 단락에 기술되어 있습니다. 우리는 내부회계관리제도감사와 관련된 대한민국의 윤리적 요구사항에 따라 회사로부터 독립적이며, 그러한 요구사항에 따른 기타 윤리적 책임들을 이행하였습니다. 우리가 입수한 감사증거가 감사의견을 위한 근거로서 충분하고 적합하다고 우리는 믿습니다.',
                                  ...
                                  "내부회계관리제도감사에 대한 감사인의 책임" = '우리의 책임은 우리의 감사에 근거하여 회사의 내부회계관리제도에 대한 의견을 표명하는데 있습니다. 우리는 회계감사기준에 따라 감사를 수행하였습니다. 이 기준은 우리가 중요성의 관점에서 내부회계관리제도가 효과적으로 유지되는지에 대한 합리적 확신을 얻도록 감사를 계획하고 수행할 것을 요구하고 있습니다. 내부회계관리제도 감사는 중요한 취약점이 존재하는지에 대한 감사증거를 입수하기 위한 절차의 수행을 포함합니다. 절차의 선택은 중요한 취약점이 존재하는지에 대한 위험평가를 포함하여 감사인의 판단에 따라 달라집니다. 감사는 내부회계관리제도에 대한 이해의 획득과 평가된 위험에 근거한 내부회계관리제도의 설계 및 운영에 대한 테스트 및 평가를 포함합니다.',
                                  ...
                                  "내부회계관리제도감사의 수행 책임" = '이 독립된 감사인의 내부회계관리제도 감사보고서의 근거가 된 감사를 실시한 업무수행이사는 공인회계사 홍준기 입니다.')

# 내부회계관리제도 감사 또는 검토 의견 중 회사의 내부회계관리제도 운영실태보고서
internal_accounting_operation <- list("보고서" = "") # 추가 예정

# 내부회계관리제도 감사 또는 검토 의견(집합)
internal_accounting_contents <- list("보고서" = meta_report_audit, "독립된 감사인의 내부회계관리제도 감사보고서" = internal_accounting_audit, 
